...
<img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExNnpnZjJpNWRiYjVsemk5ajJ0NGY2YTFhNGRpbjF3dnY1NHEzMHo3ayZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/kd9BlRovbPOykLBMqX/giphy.gif" width="400" />
...
```yaml
nombre: Aaron Mejia Vega
edad: 21 años
ubicación: Cartago, Costa Rica
enfoque: Desarrollo Web & Seguridad Informática
aprendiendo: React, Docker, Pentesting avanzado
fun_fact: "El modo oscuro es mi hábitat natural 🖥️"
```
...
> Mi portafolio profesional con proyectos web interactivos, modo oscuro, animaciones y diseño responsive. Hecho con HTML, CSS y JavaScript puro.
...
|----------|-------------|
| 🔹 [NetSec Scanner](https://github.com/MercuGmes/netsec-scanner) | Herramienta en Python para escanear redes locales |
...
- ☕ Cartago tiene el mejor café de Costa Rica.
